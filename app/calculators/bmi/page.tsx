...
import { kgToLb, lbToKg, cmToIn, inToCm } from "@/lib/core/units";
...
export default function BMIPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const validation = bmiFormula.validate({ weightKg, heightCm });
    if (!validation.valid) {
      setError(validation.issues.map((i) => i.message).join(" "));
      return;
    }
    setResult(bmiFormula.calculate({ weightKg, heightCm }));
  }
